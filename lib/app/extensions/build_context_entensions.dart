...
extension BuildContextEntension<T> on BuildContext {
  ...
  Future<T?> navigatorPushNamed(AppRoute route, {Object? argument}) async => await Navigator.of(this).pushNamed(route.path, arguments: argument);
  Future<T?> navigatorPushReplacement(Widget page) async => await Navigator.of(this).pushReplacement(MaterialPageRoute(builder: (_) => page));
  Future<T?> navigatorPushReplacementNamed(AppRoute route) async => await Navigator.of(this).pushReplacementNamed(route.path);
  ...
  TextStyle? get bodyExtraSmall => bodySmall?.copyWith(fontSize: 6, height: 1.6, letterSpacing: .5);
